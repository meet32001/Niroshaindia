    ...
    return [
      {
        ...
        slug: { current: "top-10-smart-home-gadgets-2026" },
        publishedAt: new Date().toISOString(),
        author: "Nirosha Tech Team",
        image: "https://images.unsplash.com/photo-1558002038-1055907df827?w=800&auto=format&fit=crop&q=80",
        description: "Discover the latest innovations in home automation and smart appliances.",
        body: "Smart home technology has evolved rapidly...",
      },
    ];
  } catch {
    return [
